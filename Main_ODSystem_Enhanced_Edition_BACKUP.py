...
class MarkdownViewer:
    ...
    def insert_formatted_content(self):
        ...
        self.text_widget.insert(
            tk.END,
            "Advanced AI-powered object detection and tracking system with Xbox controller integration. "
            "Enhanced edition features a modern tabbed interface, multiple detection modes, and comprehensive "
            "video source selection for professional gaming and automation applications.\n\n",
            "header",
        )
        ...
        feature_list = [
            "🎨 Color Detection Mode - Track objects by color similarity with adjustable tolerance",
            "🤖 YOLO AI Detection - Advanced person detection using YOLOv8 neural network",
            "📹 Multiple Video Sources - Screen capture, window capture, and capture card support",
            "🎮 Xbox Controller Integration - Virtual controller simulation with customizable sensitivity",
            "⚡ Real-time Performance Monitoring - CPU, memory, and FPS tracking",
            "📁 Profile Management - Save and load detection configurations",
            "🖥️ Multi-Monitor Support - Select specific monitors for screen capture",
            "🎯 Precision Tracking - Sub-pixel accuracy with smoothing algorithms",
            "🔧 Advanced Configuration - Extensive customization options",
            "📊 Live Preview - Real-time detection visualization",
        ]
        ...
        tech_specs = [
            "🧠 AI Model: YOLOv8n (Nano) - Optimized for real-time detection",
            "📹 Video Processing: OpenCV with MSS screen capture",
            "🎮 Controller: vgamepad virtual Xbox 360 controller",
            "🖼️ Image Processing: PIL/Pillow for image manipulation",
            "🔍 Detection Algorithm: HSV color space analysis and contour detection",
            "📊 Performance: Up to 60 FPS color detection, 20 FPS YOLO detection",
            "💾 Memory Management: Automatic garbage collection and memory monitoring",
            "🔧 Threading: Multi-threaded architecture for smooth operation",
        ]
        ...
        modes = [
            (
                "🎨 Color Detection",
                "Track objects based on color similarity. Ideal for tracking crosshairs, UI elements, or specific colored objects. Adjustable tolerance for precise targeting.",
            ),
            (
                "🤖 YOLO Detection",
                "AI-powered person detection using state-of-the-art YOLOv8 neural network. Automatically identifies and tracks people in real-time with high accuracy.",
            ),
            (
                "🌈 Multi-Color (Coming Soon)",
                "Track multiple colors simultaneously with independent sensitivity settings for each color target.",
            ),
        ]
        ...
        sources = [
            (
                "🖥️ Screen Capture",
                "Capture from any connected monitor. Supports multi-monitor setups with individual monitor selection. Full-screen or custom region capture.",
            ),
            (
                "🎮 Game Window",
                "Capture specific application windows. Automatic Xbox app detection and window refresh capabilities. Ideal for game streaming setups.",
            ),
            (
                "📺 Capture Card",
                "Support for external capture devices. Automatic device detection and configuration. Compatible with most USB capture cards.",
            ),
        ]
        ...
        # Controller Integration Section
        self.text_widget.insert(tk.END, "🎮 Controller Integration:\n\n", "header")

        controller_info = [
            "🔧 Virtual Controller: Creates a virtual Xbox 360 controller recognized by games",
            "🎚️ Sensitivity Control: Adjustable horizontal and vertical sensitivity settings",
            "🎯 Precision Tracking: Sub-pixel accuracy with smoothing algorithms",
            "🔄 Real-time Response: Low-latency input simulation for competitive gaming",
            "🎮 Button Integration: LB (Left Bumper) activation system",
            "⚡ Auto-centering: Automatic stick centering when no target detected",
        ]
        ...
        instructions = [
            "1️⃣ Select Detection Mode (Color or YOLO)",
            "2️⃣ Choose Video Source (Screen, Window, or Capture Card)",
            "3️⃣ Configure source settings (monitor, window, or device)",
            "4️⃣ Set target color (for Color Detection mode)",
            "5️⃣ Adjust sensitivity and tolerance settings",
            "6️⃣ Click 'Start Detection' to begin tracking",
            "7️⃣ Hold Left Bumper (LB) on controller to activate movement",
            "8️⃣ Monitor performance and adjust settings as needed",
        ]
        ...
        # Performance Tips
        self.text_widget.insert(tk.END, "⚡ Performance Tips:\n\n", "header")

        tips = [
            "🎯 Use Color Detection mode for best performance",
            "🖥️ Close unnecessary applications to free up resources",
            "📊 Monitor CPU and memory usage in Performance tab",
            "🔧 Adjust detection interval for optimal frame rates",
            "🎮 Use wired controller connection for lowest latency",
            "📹 Reduce capture resolution for better performance",
            "⚙️ Enable Windows Game Mode for consistent performance",
        ]
        ...
        troubleshooting = [
            (
                ...
                "Ensure controller is connected via USB and drivers are installed",
            ),
            (
                "High CPU usage",
                "Switch to Color Detection mode or reduce detection frequency",
            ),
            (
                "Detection not working",
                "Check video source selection and ensure target is visible",
            ),
            (
                "Laggy performance",
                "Close other applications and check system resources",
            ),
            (
                "YOLO model error",
                "Model will download automatically on first use - check internet connection",
            ),
        ]
        ...
        self.text_widget.insert(
            tk.END, "Enhanced Edition v2.0 - Professional Gaming Solutions\n"
        )
        self.text_widget.insert(tk.END, "Built with Python, OpenCV, and YOLOv8\n\n")

        self.text_widget.insert(
            tk.END,
            "For technical support and updates, check the application status bar for real-time information.\n",
        )
...
class EnhancedColorPickerApp:
    ...
    def create_controller_tab(self):
        ...
        self.controller_status_label = ttk.Label(
            status_frame, text="Status: Connected", font=("Arial", 10, "bold")
        )
